...
DECLARE
  ...
  monitor_started_at constant timestamptz := '2026-06-28 05:30:00+00';
  owner_token text;
...
BEGIN
  ...
  FOR lead_row IN
    SELECT l.*
    FROM public.leads l
    WHERE l.created_at >= monitor_started_at
  ...
  FOR booking_row IN
    ...
    WHERE b.created_at >= monitor_started_at
  ...
  FOR quiz_row IN
    ...
    WHERE q.created_at >= monitor_started_at
