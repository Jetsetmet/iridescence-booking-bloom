...
const events = [
  ...
  },
  {
    ...
    title: "Kundalini Yoga with Met @ Anarchy Yoga",
    loc: "Anarchy Yoga · LGD New Orleans · all levels welcome · ongoing weekly class",
  ...
  {
    date: "Every Wednesday", time: "10:30 AM",
    title: "Anarchy Yoga @ Spyre",
    loc: "Spyre · LGD New Orleans · all levels welcome · ongoing weekly class",
    blurb: "A raw, liberating yoga practice that breaks the rules of tradition. Move freely, breathe deeply, and reconnect with your wild, untamed self.",
    img: breathYogaHero, offering: "Breath & Yoga",
  },
];
