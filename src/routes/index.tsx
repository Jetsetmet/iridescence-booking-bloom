...
const offerings = [
  ...
  { icon: Triangle, title: "Kundalini Yoga", desc: "Saturdays 9:30am at Spyre — breath, movement and meditation to awaken your energy.", img: "/lovable-uploads/00d2e4af-2537-44d5-abf0-17707a34b6a9.webp", to: "/breath-yoga" as const },
];
